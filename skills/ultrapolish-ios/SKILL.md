...
description: Universal polish for native Swift/SwiftUI apps. Takes a competent app to a beloved one within its own visual style; never introduces a palette, a typeface, or a motion personality. This skill should be used whenever the user is building, reviewing, auditing, or refining an iOS/iPadOS app and wants it to feel considered, cohesive, premium, and detailed. Covers motion and springs, gestures and physics, colour (OKLCH, Display P3, dark mode), typography and Dynamic Type, layout and spacing (4pt grid), hierarchy, buttons and controls, sheets and detents, navigation, haptics, sound, icons and SF Symbols, copy and naming, empty/loading/error/success states, onboarding, paywalls and StoreKit, widgets, Live Activities, Dynamic Island, Liquid Glass (iOS 26), and accessibility. Triggers on polish, feels generic, feels off, premium, craft, details, cohesive, make it better, audit, review UI, spring, .snappy, .smooth, .bouncy, sheet, detent, haptic, sensoryFeedback, sound effect, button, CTA, SF Symbol, symbolEffect, microcopy, empty state, loading, skeleton, onboarding, paywall, StoreKit, widget, Live Activity, Dynamic Island, glassEffect, Dynamic Type, VoiceOver, Reduce Motion, tap target, dark mode, OKLCH, Display P3, design system, design tokens.
---
