...
5. **No system? Build one with them before polishing.** Do not hand over the technical template: it asks for OKLCH values and line-height ratios, and someone without a design system cannot fill that in. Run the six plain-language questions in the finding-the-vibe reference below, derive the numbers yourself, and show them what you derived in words they can push back on. The result is the 15-line contract in the design-contract-template reference below, agreed and committed before any pixel moves. Polishing without a contract produces a second, competing style.
...
severity to file it at, is the audit-checklist reference below, along with the one-hour audit
...
| No design system | The six plain-language questions in the finding-the-vibe reference below first, then derive the contract yourself and show it back in words they can argue with |
...
<!-- references/finding-the-vibe.md -->
